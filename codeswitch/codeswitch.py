...
class LanguageIdentification(object):
            ...
            self.tokenizer = AutoTokenizer.from_pretrained("AnkurIbySarkar/codeswitch-hineng-lid-lince")
            self.model = AutoModelForTokenClassification.from_pretrained("AnkurIbySarkar/codeswitch-hineng-lid-lince")
